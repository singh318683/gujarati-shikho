...
const MIC_TEXT = 'Gujarati Shikho uses the microphone so you can record yourself saying phrases and compare them with the model voice. Recordings stay on your device.';
...
const SNIPPET =
  '\n        // Gujarati Shikho: play lesson audio even when the ringer switch is off.\n' +
  '        do {\n' +
