...
## First-time setup
```
git clone https://github.com/singh318683/gujarati-shikho
cd gujarati-shikho/ios-app
npm install
npm run add:ios
npm run open
```
...
2. Tick "Automatically manage signing" and choose your Team. The bundle identifier is `com.ikshana.gujaratishikho`.
...
1. In App Store Connect, create a new app with the bundle identifier `com.ikshana.gujaratishikho`.
...
- Replace `[add your contact email here]` in `privacy.html`, push it, and use `https://gujarati-shikho.vercel.app/privacy.html` as the Privacy Policy URL in App Store Connect
